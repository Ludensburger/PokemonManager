...
public class TitleBar implements MenuDesign {
    ...
    public TitleBar(JFrame frame) throws IOException, FontFormatException {
    ...
    public void decorateTitleBar() throws IOException, FontFormatException {
        ...
        //  Title Panel
        getTitlePanel().setPreferredSize(new Dimension(1280, 50));
        ...
        getButtonPanel().setPreferredSize(new Dimension(100, 50));
